...
%%  pre means i+1 layer
       ...
       mmxtmpd_pre(:,:,i)=atomtype_layer1gr.*mmx_0p1(:,:,i+1)+...
                          ...
                          atomtype_layer1or.*mmx_0n1(:,:,i+1)+...
                          atomtype_layer1or.*mmx_p1p1(:,:,i+1)+...
                          atomtype_layer1or.*mmx_n1p1(:,:,i+1);
       ...
       mmytmpd_pre(:,:,i)=atomtype_layer1gr.*mmy_0p1(:,:,i+1)+...
                          ...
                          atomtype_layer1or.*mmy_0n1(:,:,i+1)+...
                          atomtype_layer1or.*mmy_p1p1(:,:,i+1)+...
                          atomtype_layer1or.*mmy_n1p1(:,:,i+1);
       ...
       mmztmpd_pre(:,:,i)=atomtype_layer1gr.*mmz_0p1(:,:,i+1)+...
                          ...
                          atomtype_layer1or.*mmz_0n1(:,:,i+1)+...
                          atomtype_layer1or.*mmz_p1p1(:,:,i+1)+...
                          atomtype_layer1or.*mmz_n1p1(:,:,i+1);

       mmxtmpd_nex(:,:,i)=r*(atomtype_layer1or.*mmx_0n1(:,:,bb-1)+ ...
                          atomtype_layer1or.*mmx_n1p1(:,:,bb-1)+...
                          atomtype_layer1or.*mmx_p1p1(:,:,bb-1)+...
                          atomtype_layer1or.*mmx_0p2(:,:,bb-1)+...
                          atomtype_layer1or.*mmx_n10(:,:,bb-1)+...
                          atomtype_layer1or.*mmx_p10(:,:,bb-1)+...
       ...
       mmytmpd_nex(:,:,i)=r*(atomtype_layer1or.*mmy_0n1(:,:,bb-1)+ ...
                          ...
                          atomtype_layer1or.*mmy_p1p1(:,:,bb-1)+...
                          atomtype_layer1or.*mmy_0p2(:,:,bb-1)+...
                          atomtype_layer1or.*mmy_n10(:,:,bb-1)+...
                          atomtype_layer1or.*mmy_p10(:,:,bb-1)+...
      ...
      mmztmpd_nex(:,:,i)=r*(atomtype_layer1or.*mmz_0n1(:,:,bb-1)+ ...
                          ...
                          atomtype_layer1or.*mmz_0p2(:,:,bb-1)+...
                          atomtype_layer1or.*mmz_n10(:,:,bb-1)+...
                          atomtype_layer1or.*mmz_p10(:,:,bb-1)+...
    ...
    case 1
       ...
       mmxtmpd_nex(:,:,i)=atomtype_layer2p.*mmx_0n1(:,:,i-1)+...
                          atomtype_layer2p.*mmx_n1p1(:,:,i-1)+...
                          atomtype_layer2p.*mmx_p1p1(:,:,i-1)+...
                          atomtype_layer2p.*mmx_0p1(:,:,i-1)+...
                          atomtype_layer2p.*mmx_n1n1(:,:,i-1)+...
                          atomtype_layer2p.*mmx_p1n1(:,:,i-1)+...
       ...
       mmytmpd_nex(:,:,i)=atomtype_layer2p.*mmy_0n1(:,:,i-1)+...
                          atomtype_layer2p.*mmy_n1p1(:,:,i-1)+...
                          atomtype_layer2p.*mmy_p1p1(:,:,i-1)+...
                          atomtype_layer2p.*mmy_0p1(:,:,i-1)+...
                          atomtype_layer2p.*mmy_n1n1(:,:,i-1)+...
                          atomtype_layer2p.*mmy_p1n1(:,:,i-1)+...
       ...
       mmztmpd_nex(:,:,i)=atomtype_layer2p.*mmz_0n1(:,:,i-1)+...
                          atomtype_layer2p.*mmz_n1p1(:,:,i-1)+...
                          atomtype_layer2p.*mmz_p1p1(:,:,i-1)+...
                          atomtype_layer2p.*mmz_0p1(:,:,i-1)+...
                          atomtype_layer2p.*mmz_n1n1(:,:,i-1)+...
                          atomtype_layer2p.*mmz_p1n1(:,:,i-1)+...
       ...
       mmxtmpd_pre(:,:,i)=r*(atomtype_layer3red.*mmx_0n2(:,:,hh+1)+...
                          atomtype_layer3red.*mmx_n10(:,:,hh+1)+...
                          atomtype_layer3red.*mmx_p10(:,:,hh+1)+...
                          atomtype_layer3black.*mmx_0n1(:,:,hh+1)+...
                          atomtype_layer3black.*mmx_n1p1(:,:,hh+1)+...
                          atomtype_layer3black.*mmx_p1p1(:,:,hh+1)+...
                          atomtype_layer3black.*mmx_0p1(:,:,hh+1)+...
                          atomtype_layer3black.*mmx_n1n1(:,:,hh+1)+...
                          atomtype_layer3black.*mmx_p1n1(:,:,hh+1));
       mmytmpd_pre(:,:,i)=r*(atomtype_layer3red.*mmy_0n2(:,:,hh+1)+...
                          atomtype_layer3red.*mmy_n10(:,:,hh+1)+...
                          atomtype_layer3red.*mmy_p10(:,:,hh+1)+...
                          atomtype_layer3black.*mmy_0n1(:,:,hh+1)+...
                          atomtype_layer3black.*mmy_n1p1(:,:,hh+1)+...
                          atomtype_layer3black.*mmy_p1p1(:,:,hh+1)+...
                          atomtype_layer3black.*mmy_0p1(:,:,hh+1)+...
                          atomtype_layer3black.*mmy_n1n1(:,:,hh+1)+...
                          atomtype_layer3black.*mmy_p1n1(:,:,hh+1));
       mmztmpd_pre(:,:,i)=r*(atomtype_layer3red.*mmz_0n2(:,:,hh+1)+...
                          atomtype_layer3red.*mmz_n10(:,:,hh+1)+...
                          atomtype_layer3red.*mmz_p10(:,:,hh+1)+...
                          atomtype_layer3black.*mmz_0n1(:,:,hh+1)+...
                          atomtype_layer3black.*mmz_n1p1(:,:,hh+1)+...
                          atomtype_layer3black.*mmz_p1p1(:,:,hh+1)+...
                          atomtype_layer3black.*mmz_0p1(:,:,hh+1)+...
                          atomtype_layer3black.*mmz_n1n1(:,:,hh+1)+...
                          atomtype_layer3black.*mmz_p1n1(:,:,hh+1));

       mmxtmpd_nex(:,:,i)=atomtype_layer3red.*mmx_0n2(:,:,i-1)+...
                          atomtype_layer3red.*mmx_n10(:,:,i-1)+...
                          atomtype_layer3red.*mmx_p10(:,:,i-1)+...
                          atomtype_layer3red.*mmx_0p2(:,:,i-1)+...
                          atomtype_layer3red.*mmx_n1n1(:,:,i-1)+...
                          atomtype_layer3red.*mmx_p1n1(:,:,i-1)+...
       ...
       mmytmpd_nex(:,:,i)=atomtype_layer3red.*mmy_0n2(:,:,i-1)+...
                          ...
                          atomtype_layer3red.*mmy_0p2(:,:,i-1)+...
                          atomtype_layer3red.*mmy_n1n1(:,:,i-1)+...
                          atomtype_layer3red.*mmy_p1n1(:,:,i-1)+...
       ...
       mmztmpd_nex(:,:,i)=atomtype_layer3red.*mmz_0n2(:,:,i-1)+...
                          ...
                          atomtype_layer3red.*mmz_0p2(:,:,i-1)+...
                          atomtype_layer3red.*mmz_n1n1(:,:,i-1)+...
                          atomtype_layer3red.*mmz_p1n1(:,:,i-1)+...
