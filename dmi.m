...
for i=1:h     
    ...
    switch mod(i-1,3)
        case 0 %%tpye layer 1
       mmxtmpd_pre(:,:,i)=atomtype_layer1gr.*mmx_0p1_pre(:,:,i)+...
                          atomtype_layer1gr.*mmx_n1n1_pre(:,:,i)+...
                          atomtype_layer1gr.*mmx_p1n1_pre(:,:,i)+...
                          atomtype_layer1gr.*mmx_0n2_pre(:,:,i)+...
                          atomtype_layer1gr.*mmx_p10_pre(:,:,i)+...
                          atomtype_layer1gr.*mmx_n10_pre(:,:,i);
       mmytmpd_pre(:,:,i)=atomtype_layer1gr.*mmy_0p1_pre(:,:,i)+...
                          atomtype_layer1gr.*mmy_n1n1_pre(:,:,i)+...
                          atomtype_layer1gr.*mmy_p1n1_pre(:,:,i)+...
                          atomtype_layer1gr.*mmy_0n2_pre(:,:,i)+...
                          atomtype_layer1gr.*mmy_p10_pre(:,:,i)+...
                          atomtype_layer1gr.*mmy_n10_pre(:,:,i);
       mmztmpd_pre(:,:,i)=atomtype_layer1gr.*mmz_0p1_pre(:,:,i)+...
                          atomtype_layer1gr.*mmz_n1n1_pre(:,:,i)+...
                          atomtype_layer1gr.*mmz_p1n1_pre(:,:,i)+...
                          atomtype_layer1gr.*mmz_0n2_pre(:,:,i)+...
                          atomtype_layer1gr.*mmz_p10_pre(:,:,i)+...
                          atomtype_layer1gr.*mmz_n10_pre(:,:,i);
       mmxtmpd_nex(:,:,i)=r*(atomtype_layer1or.*mmx_0n1_nex(:,:,i)+ ...
                          atomtype_layer1or.*mmx_n1p1_nex(:,:,i)+...
                          atomtype_layer1or.*mmx_p1p1_nex(:,:,i)+...
                          atomtype_layer1gr.*mmx_0p1_nex(:,:,i)+...
                          atomtype_layer1gr.*mmx_n1n1_nex(:,:,i)+...
                          atomtype_layer1gr.*mmx_p1n1_nex(:,:,i));
       mmytmpd_nex(:,:,i)=r*(atomtype_layer1or.*mmy_0n1_nex(:,:,i)+ ...
                          atomtype_layer1or.*mmy_n1p1_nex(:,:,i)+...
                          atomtype_layer1or.*mmx_p1p1_nex(:,:,i)+...
                          atomtype_layer1gr.*mmy_0p1_nex(:,:,i)+...
                          atomtype_layer1gr.*mmy_n1n1_nex(:,:,i)+...
                          atomtype_layer1gr.*mmy_p1n1_nex(:,:,i));
      mmztmpd_nex(:,:,i)=r*(atomtype_layer1or.*mmz_0n1_nex(:,:,i)+ ...
                          atomtype_layer1or.*mmz_n1p1_nex(:,:,i)+...
                          atomtype_layer1or.*mmz_p1p1_nex(:,:,i)+...
                          atomtype_layer1gr.*mmz_0p1_nex(:,:,i)+...
                          atomtype_layer1gr.*mmz_n1n1_nex(:,:,i)+...
                          atomtype_layer1gr.*mmz_p1n1_nex(:,:,i));
    case 1
       mmxtmpd_pre(:,:,i)=atomtype_layer2blue.*mmx_0p2_pre(:,:,i)+...
                          atomtype_layer2blue.*mmx_n10_pre(:,:,i)+...
                          atomtype_layer2blue.*mmx_p10_pre(:,:,i)+...
                          atomtype_layer2blue.*mmx_0n1_pre(:,:,i)+...
                          atomtype_layer2blue.*mmx_n1p1_pre(:,:,i)+...
                          atomtype_layer2blue.*mmx_p1p1_pre(:,:,i);
       mmytmpd_pre(:,:,i)=atomtype_layer2blue.*mmy_0p2_pre(:,:,i)+...
                          atomtype_layer2blue.*mmy_n10_pre(:,:,i)+...
                          atomtype_layer2blue.*mmy_p10_pre(:,:,i)+...
                          atomtype_layer2blue.*mmy_0n1_pre(:,:,i)+...
                          atomtype_layer2blue.*mmy_n1p1_pre(:,:,i)+...
                          atomtype_layer2blue.*mmy_p1p1_pre(:,:,i);     
       mmztmpd_pre(:,:,i)=atomtype_layer2blue.*mmz_0p2_pre(:,:,i)+...
                          atomtype_layer2blue.*mmz_n10_pre(:,:,i)+...
                          atomtype_layer2blue.*mmz_p10_pre(:,:,i)+...
                          atomtype_layer2blue.*mmz_0n1_pre(:,:,i)+...
                          atomtype_layer2blue.*mmz_n1p1_pre(:,:,i)+...
                          atomtype_layer2blue.*mmz_p1p1_pre(:,:,i);

       mmxtmpd_nex(:,:,i)=atomtype_layer2p.*mmx_0n1_nex(:,:,i)+...
                          atomtype_layer2p.*mmx_n1p1_nex(:,:,i)+...
       ...
       mmytmpd_nex(:,:,i)=atomtype_layer2p.*mmy_0n1_nex(:,:,i)+...
                          atomtype_layer2p.*mmy_n1p1_nex(:,:,i)+...
       ...
       mmztmpd_nex(:,:,i)=atomtype_layer2p.*mmz_0n1_nex(:,:,i)+...
                          atomtype_layer2p.*mmz_n1p1_nex(:,:,i)+...
       ...
       mmxtmpd_pre(:,:,i)=r*(atomtype_layer3red.*mmx_0p1_pre(:,:,i)+...
                          atomtype_layer3red.*mmx_n1n1_pre(:,:,i)+...
                          atomtype_layer3red.*mmx_p1n1_pre(:,:,i)+...
                          atomtype_layer3black.*mmx_0n1_pre(:,:,i)+...
                          atomtype_layer3black.*mmx_n1p1_pre(:,:,i)+...
                          atomtype_layer3black.*mmx_p1p1_pre(:,:,i));
       mmytmpd_pre(:,:,i)=r*(atomtype_layer3red.*mmy_0p1_pre(:,:,i)+...
                          atomtype_layer3red.*mmy_n1n1_pre(:,:,i)+...
                          atomtype_layer3red.*mmy_p1n1_pre(:,:,i)+...
                          atomtype_layer3black.*mmy_0n1_pre(:,:,i)+...
                          atomtype_layer3black.*mmy_n1p1_pre(:,:,i)+...
                          atomtype_layer3black.*mmy_p1p1_pre(:,:,i));       
       mmztmpd_pre(:,:,i)=r*(atomtype_layer3red.*mmz_0p1_pre(:,:,i)+...
                          atomtype_layer3red.*mmz_n1n1_pre(:,:,i)+...
                          atomtype_layer3red.*mmz_p1n1_pre(:,:,i)+...
                          atomtype_layer3black.*mmz_0n1_pre(:,:,i)+...
                          atomtype_layer3black.*mmz_n1p1_pre(:,:,i)+...
                          atomtype_layer3black.*mmz_p1p1_pre(:,:,i));
       mmxtmpd_nex(:,:,i)=atomtype_layer3red.*mmx_0n2_nex(:,:,i)+...
                          atomtype_layer3red.*mmx_n10_nex(:,:,i)+...
       ...
       mmytmpd_nex(:,:,i)=atomtype_layer3red.*mmy_0n2_nex(:,:,i)+...
                          atomtype_layer3red.*mmy_n10_nex(:,:,i)+...
       ...
       mmztmpd_nex(:,:,i)=atomtype_layer3red.*mmz_0n2_nex(:,:,i)+...
                          atomtype_layer3red.*mmz_n10_nex(:,:,i)+...
