        ...
        switch mod(i-1,3)
            ...
            case 2
               if i==h
                ...
                %blue in the 2nd layer is identical to orange in 1st layer
                shift_matx_black=b*(atomtype_layer3black.*(mmx_0n1(:,:,hh+1)+...
                    mmx_n1p1(:,:,hh+1)+...
                    mmx_p1p1(:,:,hh+1))+...
                    mmx_0p1(:,:,i-1)+...
                    mmx_n1n1(:,:,i-1)+...
                    mmx_p1n1(:,:,i-1));
                shift_maty_black=b*(atomtype_layer3black.*(mmy_0n1(:,:,hh+1)+...
                    mmy_n1p1(:,:,hh+1)+...
                    mmy_p1p1(:,:,hh+1))+...
                    mmy_0p1(:,:,i-1)+...
                    mmy_n1n1(:,:,i-1)+...
                    mmy_p1n1(:,:,i-1));
                shift_matz_black=b*(atomtype_layer3black.*(mmz_0n1(:,:,hh+1)+...
                    mmz_n1p1(:,:,hh+1)+...
                    mmz_p1p1(:,:,hh+1))+...
                    mmz_0p1(:,:,i-1)+...
                    mmz_n1n1(:,:,i-1)+...
                ...
                %blue in the 2nd layer is identical to orange in 1st layer
                shift_matx_red=b*(atomtype_layer3red.*(mmx_p10(:,:,hh+1)+...
                    mmx_n10(:,:,hh+1)+...
                    mmx_0n2(:,:,hh+1))+...
                    mmx_0p1(:,:,i-1)+...
                    mmx_n1n1(:,:,i-1)+...
                    mmx_p1n1(:,:,i-1));
                shift_maty_red=b*(atomtype_layer3red.*(mmy_p10(:,:,hh+1)+...
                    mmy_n10(:,:,hh+1)+...
                    mmy_0n2(:,:,hh+1))+...
                    mmy_0p1(:,:,i-1)+...
                    mmy_n1n1(:,:,i-1)+...
                    mmy_p1n1(:,:,i-1));
                shift_matz_red=b*(atomtype_layer3red.*(mmz_p10(:,:,hh+1)+...
                    mmz_n10(:,:,hh+1)+...
                    mmz_0n2(:,:,hh+1))+...
                    mmz_0p1(:,:,i-1)+...
                    mmz_n1n1(:,:,i-1)+...
...
% mmxtmpJzx_1=mmxtmpJ_1;mmytmpJzx_1=mmytmpJ_1;mmztmpJzx_1=mmztmpJ_1;
% mmxtmpJzx_2=mmxtmpJ_2;mmytmpJzx_2=mmytmpJ_2;mmztmpJzx_2=mmztmpJ_2;
% mmxtmpJzx_3=mmxtmpJ_3;mmytmpJzx_3=mmytmpJ_3;mmztmpJzx_3=mmztmpJ_3;
% mmxtmpJzx_4=mmxtmpJ_4;mmytmpJzx_4=mmytmpJ_4;mmztmpJzx_4=mmztmpJ_4;
% % load('debugtmp.mat');
